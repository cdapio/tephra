...
public final class DefaultZKClientService extends AbstractZKClient implements ZKClientService {
  ...
  private final CaskService serviceDelegate;
  ...
  @Override
  public void addListener(CaskService.Listener listener, Executor executor) {
  ...
  private final class ServiceDelegate extends CaskAbstractService implements Watcher {
    ...
    public void process(WatchedEvent event) {
      ...
      try {
        if (event.getState() == Event.KeeperState.SyncConnected && state == Service.State.STARTING) {
