...
public class PooledClientProviderTest {
  ...
  private void startClientAndTestPool(Configuration conf) throws Exception {
    ...
    final PooledClientProvider clientProvider =
      new PooledClientProvider(conf, injector.getInstance(DiscoveryServiceClient.class));
  ...
  private static class RetrieveClient implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
      begin.await();
      CloseableThriftClient client = pool.getCloseableClient();
      try {
