...
public class TransactionProcessor extends BaseRegionObserver {
   ...
   */
  protected Filter getTransactionFilter(Transaction tx, ScanType scanType, boolean excludeCurrentWritePtr) {
    return new TransactionVisibilityFilter(tx, ttlByFamily, allowEmptyValues, scanType, null, excludeCurrentWritePtr);
  }
